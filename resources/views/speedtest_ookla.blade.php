...
<head>
    ...
    <style>
      .loading {
                        background-image: url("assets/images/field-loader.gif");
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            ...
                            <canvas id="oilChart" style='height: 80px'></canvas>

                        </div>

                        <div class="col-md-4">
                            <h6>Upload Speed</h6>
                            <canvas id="oilChart2" style='height: 80px'></canvas>
                    ...
                    <button onclick="startTest()" class="btn btn-primary btn-md">Start Test</button>
                    <button class="btn btn-info btn-md" id="download">Download Report</button>

                    <button onclick="printdiv('result')" class="btn btn-warning btn-md">Print</button>
                  ...
                  var needleval = '0';
                    ...
                    var chart1 = new Chart('oilChart', {
                        type: 'doughnut',
                        plugins: [{
                            afterDraw: chart => {
                                var needleValue = chart.chart.config.data.datasets[0].needleValue;
                                var dataTotal = chart.chart.config.data.datasets[0].data.reduce((a,
                                    b) => a + b, 0);
                    ...
                    var chart2 = new Chart('oilChart2', {
                        type: 'doughnut',
                        plugins: [{
                            afterDraw: chart => {
                                var needleValue = chart.chart.config.data.datasets[0].needleValue;
                    ...
                    function startTest(){
                      id = setInterval(getOoklaSpeedtest, 1000);
                      setTimeout(stopTest, 20000);
                    }
                    ...
                    // setInterval(getOoklaSpeedtest, 1000);
                    // getOoklaSpeedtest();

                    function getOoklaSpeedtest() {
                        $.ajax({
                            ...
                            success: function(data) {     
                              $('#result').removeClass('loading');                        
                                ...
                                addData2(16);
                                if(data.split('Download:')[1]!=undefined){
                                  if(isNAN(data.split('Download:')[1])){
                                    addData(data.split('Download:')[1]);
                                  }
                                }

                                if(data.split('Upload:')[1]!==undefined){
                                  if(isNAN(data.split('Upload:')[1]).substring(0,5)){
                                    addData2(data.split('Upload:')[1].substring(0,5));
                                  }
                                }


                                // console.log(data+"".split('Download: ')[1]);
                                // console.log(data+"".split('Upload: ')[0]);
                    ...
                    function addData(data) {
                        chart1.data.needleValue = data;
                        chart1.update();
                    }


                    function addData2(data) {
                        chart2.data.needleValue = data;
                        chart2.update();
                    }
